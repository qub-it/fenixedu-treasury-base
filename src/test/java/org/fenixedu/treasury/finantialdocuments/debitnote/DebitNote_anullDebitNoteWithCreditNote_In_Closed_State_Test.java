...
public class DebitNote_anullDebitNoteWithCreditNote_In_Closed_State_Test {
    ...
    public void testcase5_oneDebitEntryFullyCreditedBeforeAnnul() {
        ...
        debitEntry1.creditDebitEntry(new BigDecimal("1000"), "manual credit", false, Collections.emptyMap());
