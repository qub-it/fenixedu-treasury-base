...
public class MonthlyInterestRateType extends MonthlyInterestRateType_Base {
    ...
    private InterestRateBean calculateInterestRateBean(DebitEntry debitEntry, LocalDate paymentDate, boolean withAllInterestValues, LocalDate dueDate,
            BigDecimal interestsPercentage, boolean postponePaymentLimitDateToFirstWorkDate, boolean applyPenaltyInFirstWorkday) {
        ...
        BigDecimal interestAmount = Currency.getValueWithScale(debitEntry.getNetAmount()
    ...
    public static LocalizedString getPresentationName() {
        return new LocalizedString(new Locale("pt"), "Monthly interest rate");
    }
